...
{
    class magic_stereo_nodelet : public nodelet::Nodelet // 任何nodelet plugin都要继承Nodelet类。
    {
    public:
        magic_stereo_nodelet()
        {
        }
         ...
         void stereoLoop(ros::NodeHandle& nh_);
    private:
        ...
        std::unique_ptr<boost::thread> image_thread_ ;
